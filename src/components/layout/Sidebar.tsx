...
import { LayoutDashboard, PlayCircle, Bookmark, LogOut } from "lucide-react";
        ...
        <nav style={{ display: "flex", flexDirection: "column", gap: 4, marginBottom: 8 }}>
          {NAV_ITEMS.map(({ href, label, icon: Icon, badge }) => {
            ...
            return (
              ...
              >
                <Icon style={{ width: 16, height: 16, flexShrink: 0, color: isActive ? "#2E7D32" : "#9CA3AF" }} />
